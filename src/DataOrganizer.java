...
//
	...
	//		without having access to an applet at the top level.
	//
	...
	public DataOrganizer(Applet someApplet)
	{
		...
		theApplet.addMouseListener(this);		//	"this" class handles the mouse
		...
		collection = new ArrayDataCollection();
	}
...
//		the buttons.
	...
	{
		collection =							//	We restart with nothing,
				new ArrayDataCollection(x, y);	//		then we add random items,
...
//
	public void paint(Graphics pane)
	{
		if (collection != null)					//	When instantiated,
			collection.paint(pane);				//		we display the items
